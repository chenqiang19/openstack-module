...
public class Volume extends AbstractEntity {
    ...
    public Volume(JSONObject header, JSONObject body) {
        JSONObject volume = body.getJSONObject("volume");
        this.id = volume.getString("id");
        if (getName() == null) {
            this.name = volume.optString("display_name", null);
        }
        if (getDescription() == null)
    ...
    public String getImageRef() { return this.imageRef; }
...
//        this.displayName = name;
    ...
    public void setAvailabilityZone(String availability_zone) { this.availabilityZone = availability_zone; }
