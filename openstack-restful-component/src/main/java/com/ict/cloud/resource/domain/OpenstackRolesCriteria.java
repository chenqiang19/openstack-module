...
public class OpenstackRolesCriteria {
    ...
    public OpenstackRolesCriteria limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public OpenstackRolesCriteria limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public OpenstackRolesCriteria page(Integer page, Integer pageSize) {
