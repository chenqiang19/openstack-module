...
public abstract class AbstractHTTPRequest implements Request{
	...
	protected abstract Response patch(String url, Object data) throws IOException;
	@Override
	...
	@Override
	public Response doPatch(Header header, String url, Object data) throws IOException {
		before(header);
