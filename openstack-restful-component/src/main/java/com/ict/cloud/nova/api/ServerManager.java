...
public interface ServerManager {
	...
	/**
	 * Get detail of servers.
	 * @return List of server
	 * @throws OperationException
	 */
	List<Server> detail() throws OperationException;

	void addFloatingIp(String id, String address, String fixed_address) throws OperationException;
	 ...
	 * @throws OperationException
	 */
	String stop(String id) throws OperationException;
	/**
	 * Start(power on) the server,
	 * @param id The id of server to start.
	 * @throws OperationException
	 */
	 String start(String id) throws OperationException;
	 /**
	  * Reboot a server.
	  ...
	  */
	 String reboot(String id, boolean hard) throws OperationException;
	 /**
	  * Reboot a server, for a software-lever reboot
	  * @param id The ID of server to reboot.
	  */
	 String reboot(String id) throws OperationException;
	 /**
	  * Get a VNC console url for an instance, novnc only, xvpvnc not support.
	  * @param id The ID of server to get console from.
	  * @throws OperationException
	  */
	 Console getConsole(String id, String type, String console) throws OperationException;
	 /**
	 ...
	 * Required that qemu-guest-agent is installed and in the path
	 * @param id the id of instance to get password
	 * @return
	 * @throws OperationException
	 */
	 void changePassword(String id, String newPassword) throws OperationException;
	 /**
	...
	/**
	 * connect volume to a server instance.
	 * @param id The id to share onto.
	 * @param body volume info.
	 * @throws OperationException
	 */
	String connectVolume(String id, String body)  throws OperationException;
	/**
	 * disconnect volume to a server instance.
	 * @param id The id to share onto.
	 * @param volumeId is volume unique tag.
	 * @throws OperationException
	 */
	void disconnectVolume(String id, String volumeId) throws OperationException;
	/**
	 * list data volumes of a server instance.
	 * @param id The id to share onto.
	 * @throws OperationException
	 */
	List<Server.VolumeAttachment> listServerVolume(String id) throws OperationException;

	/**
	 * create virtual network card.
	 * @param serverId The id of instance.
	 * @throws OperationException
	 */
	Server.InterfaceAttachment createInterface(String serverId, Server.InterfaceAttachment interfaceAttachment) throws OperationException;

	/**
	 * list virtual network card a server instance.
	 * @param serverId The id to share onto.
	 * @throws OperationException
	 */
	List<Server.InterfaceAttachment> listInterface(String serverId) throws OperationException;

	/**
	 * delete virtual network card a server instance.
	 * @param serverId The id to share onto.
	 * @throws OperationException
	 */
	void deleteInterface(String serverId) throws OperationException;

	/**
	 * query virtual network card port of a server instance.
	 * @param serverId The id to share onto.
	 * @throws OperationException
	 */
	Server.InterfaceAttachment detailInterface(String serverId, String portId) throws OperationException;
}
